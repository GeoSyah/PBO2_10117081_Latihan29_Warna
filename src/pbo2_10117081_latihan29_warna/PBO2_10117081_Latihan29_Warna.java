 ...
 */
package pbo2_10117081_latihan29_warna;
 ...
 * NIM : 10117081 
 * Kelas : IF2/PBO2 
 * Deskripsi Program : Mempelihatkan kepribadian seseorang dari warna yang disukai
 */
public class PBO2_10117081_Latihan29_Warna {
    ...
    public static void hasil(String warnaPilih) {
        String warna = warnaPilih.toUpperCase();
        switch (warna) {
            case "MERAH":
